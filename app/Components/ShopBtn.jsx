...
function ShopBtn({ linkPath }) {
  ...
  return (
    <Link
      href={linkPath}
      className="relative group flex items-center justify-center w-[11vw] h-[3.25vw] bg-white rounded-full gap-[0.5vw] overflow-hidden max-[950px]:w-[20vw] max-[950px]:h-[6vw]"
    >
      <div className="">
        ...
        <Image
          ...
          height={15}
        />
        <h6 className="absolute group-hover:left-[50%] flex items-center justify-center text-primary text-nowrap font-semibold z-[1] group-hover:text-white transition-all ease-linear duration-[0.3s]  max-[950px]:top-[55%] translate-y-[-50%] translate-x-[-50%] size-full left-[60%]">
          SHOP NOW
        </h6>
      </div>
    </Link>
